...
class Container
{
    ...
    private function __construct()
    {
        ...
        $this->ordersHistoryInfoLog = $this->logDir . 'order/history_info.log';
        $this->callsLog             = $this->logDir . 'order/call.log';
        ...
        $this->subscriberLog        = $this->logdir . 'customer/subscriber.log';
    }
