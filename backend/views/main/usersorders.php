        ...
        <div class="panel">
            ...
            <div class="panel-heading">
                <form action="" id="form_users">
					...
					По кол-ву заказов
					<div class="input-group">
						<input type="text" class="form-control" style="width: 150px" placeholder="с" name="from_count" value="<?=$_GET['from_count']?>">
						<input type="text" class="form-control" style="width: 150px" placeholder="по" name="to_count" value="<?=$_GET['to_count']?>">
						<button class="btn btn-default" type="submit" onclick="$(this).val(1)" name="count_orders"><i class="fa fa-eye"></i> Показать</button>	
					</div> 					
                </form>
            </div>
            <div class="panel-heading">
				...
				foreach ($items as $item): ?>
                    <tr id="layout_normal">
                        ...
                        <td class="actions text-right">
                            ...
                            <? endif ?>
                            <a href="<?= Url::to(['orders/control', 'user_id' => $item['id']]) ?>" class="btn-primary btn-xs btn" target="_blank" title="Создать заказ">
