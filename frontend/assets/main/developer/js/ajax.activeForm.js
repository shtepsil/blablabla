                ...
                $form.ajaxForm(
                    {
                        ...
                        success: function (data_return) {
                            ...
                            if (typeof data_return != 'undefined') {
                                ...
                                if ('message' in data_return && 'duration' in data_return.message) {
                                    duration = +data_return.message.duration;
                                }

                                if (typeof data_return.errors != 'undefined') {
                                    var msgs = data_return.errors;
                                    $form.data('yiiActiveForm').ajax_update = true;
                                    //$.growl.error({title:'Ошибка', message: 'Вы незаполнили все поля' ,duration: timeView});
                                    ...
                                    if (typeof data_return.message != 'undefined') {
                                        ...
                                        if (typeof message.error != 'undefined') {
                                            cl(duration);
                                            $.growl.error({ title: 'Ошибка', message: message.error, duration: duration });
                                        }
                        ...
                        error: function (data_result) {
                            ...
                            res.html(JSON.stringify('Fail<br>' + data_result.responseText));
                            $('#loader').hide();
                            $.growl.error({ title: 'Ошибка', message: "Произошла ошибка на стороне сервера!", duration: 5000 });
                        }
                    }
